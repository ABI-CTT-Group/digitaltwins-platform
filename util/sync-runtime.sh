...
excludes=(
  ...
  --filter='P services/airflow/config/**'                      # sync TRACKED config (airflow.cfg, webserver_config.py) but PROTECT airflow-init's runtime-generated files there from --delete
